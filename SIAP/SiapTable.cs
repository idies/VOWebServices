...
namespace VOServices
{
    ...
    /// @Deoyani Nandrekar-Heinis February 10 2015
    /// </summary>
    ...
    public class SiapTable : VOTABLE
    {
        ...
        public int addUrlInfo(int ind)
        {
            ...
            this.INFO[ind].Text[0] = sdssFieldsUrl;
            ind++;
            this.INFO[ind] = new INFO();
        ...
        public string getDataRelease()
        {
            ...
            //            dr = value.Substring(indexDR, 3);
            //        else
            //            throw new Exception("Data Release number is not specified properly.");
            //    }
            //}
            //catch (Exception ex)
            //{
 ...
 * 
 * 
 * February 2015 : cleaned and rewritten @Deoyani , update the code as get time, its old
